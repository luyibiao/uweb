  ...
  <div class="m-t-lg"
    ...
    <table class="ukao-tb-default ukao-table b-t w-full">
      <tbody>
          ...
          <td style="width: 20%">
            <auth perm="store.price.update">
              <el-button size="small"
                       @click="openBaseDialog('所属门店','store',getStoreList)">修改</el-button>
            </auth>
          </td>
        </tr>
        <tr>
        ...
        <tr v-for="(item, index) in serviceRel"
            :key="item.id">
          ...
          <td>
            <auth perm="store.price.update">
              <el-button size="small" @click="openPriceDialog(item)">修改</el-button>
            </auth>
          </td>
        </tr>
        <tr>
      ...
      <div>
        <el-form :model="ruleForm"
          ...
          <div class="price-item"
            ...
            <template v-for="(item, index) in ruleForm.priceList">
