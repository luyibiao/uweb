			...
			<div class="membership-content">
				<el-form :model="ruleForm"  ref="ruleForm" label-width="100px" class="demo-ruleForm">
				  ...
				  <el-form-item label="每人限领" prop="perUserNum" :rules="[
				    { required: eventForm.perUserNumCheckbox2, message: '请填写每人限领张数', trigger: 'blur' },
				    {validator: checkNumber, min:1, max:99999, ignoreEmpty:!eventForm.perUserNumCheckbox2, message: '每人限领数1至99999之间的正整数', trigger: 'blur'}
				  ]">
			      <div>
				  ...
				  <el-form-item v-if="ruleForm.dateType==1" label="有效日期" prop="timeStart"  :rules="[
					...
					<el-form-item v-if="ruleForm.dateType==2" label="有效天数" prop="term" :rules="[
    ...
    components: {couponUseRule}, data: function() {
		...
		methods: {
			...
			changeTimeStart(item){
				if(item){
					this.ruleForm.timeStart = item[0];
					this.ruleForm.timeEnd = item[1];
				}else{
