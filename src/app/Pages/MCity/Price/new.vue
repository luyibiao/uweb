	...
	<div v-loading="loading">
		<div class="m-l-xxl">
			<el-form :model="ruleForm"  ref="ruleForm" label-width="100px">
			  ...
			  <el-form-item>
					<router-link :to="'/mcity/price/'+cityInfo.id+'/list'">
...
<script>
    ...
    data: function() {
          ...
          typeId: '',
					...
					discount: '',
					sortNo: '',
          priceList:[],	//{tmpId:'', serviceId: '',prop: '', name: '', price:'',showPrice: '', isShow:''}
					prices:{},
					imgPath: '',
        },
			}
					...
					if (valid) {
						this.$store.dispatch('post', {
							...
							data: this.ruleForm
								...
								msg.success();
								this.$router.push({ path: '/mcity/price/'+this.cityInfo.id+'/list' })
						})
					}else{
						return false
					}
