<template>
	<div>
		<el-breadcrumb class="link-back" separator="/">
		  <el-breadcrumb-item to="/weixin/project"><i class="el-icon-arrow-left icon-smaller"></i>经营项目</el-breadcrumb-item>
		  <el-breadcrumb-item :to="'/weixin/project/detail/'+mercBusiness.id">{{mercBusiness.name}}</el-breadcrumb-item>
		  <el-breadcrumb-item :to="'/weixin/project/products/'+mercBusiness.id">服务产品</el-breadcrumb-item>
		...
		<div class="m-t-lg m-l-xxl">
			<el-form :model="ruleForm"  ref="ruleForm" label-width="100px" class="demo-ruleForm">
				...
				<el-form-item label="产品图片" prop="imgPath">
					<Uploader
					tip="格式必须为：png,jpeg,jpg,不可大于2M;尺寸246*224"
					size="2"
				...
				<el-form-item>
					<router-link :to="'/weixin/project/products/'+mercBusiness.id">
					...
					if (valid) {
						this.$store.dispatch('post', {
							...
							data: this.ruleForm
								...
								msg.success();
								this.$router.push({ path: '/weixin/project/products/'+this.mercBusiness.id })
						})
					}else{
						return false
					}
