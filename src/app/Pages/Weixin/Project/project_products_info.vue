		...
		<div class="main">
			<div class="text-right clearfix">
				<el-breadcrumb class="pull-left link-back" separator="/">
					...
					<el-breadcrumb-item :to="'/weixin/project/detail/'+mercBusiness.id">
						<span v-if="ruleForm.exp">{{ruleForm.exp.mercBusinessName}}</span>
					</el-breadcrumb-item>
						...
						<el-form :model="ruleForm"  ref="ruleForm" label-width="150px">
							...
							<el-form-item class="w-lg" label="所属类别" prop="typeId" v-if="dialog.attr === 'type'"
								...
								<el-select v-model="ruleForm.typeId" clearable placeholder="请选择所属类别" @change="selectedProductType">
								  ...
								  <el-form-item label="" prop="imgPath" v-if="dialog.attr === 'imgPath'">
										<Uploader
