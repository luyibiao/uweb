<template>
	<div v-loading="loading">
      ...
      <el-breadcrumb-item to="/weixin/price/list">
    ...
    <div class="m-l-xxl  m-t-lg m-r-xxl">
        ...
        <div class="pull-left" style="width:40%;">
					...
					<div class="price-item"  v-if="ruleForm.priceList && ruleForm.priceList.length > 0">
						<el-form-item class="w-fohg" :label="item.name" :key="item.index"
      ...
      getTranTypeList () {
        ...
        let _this = this
          ...
          if (res.data.httpCode == 200) {
            ...
            this.$router.push({ path: '/weixin/price/list' })
          } else {
