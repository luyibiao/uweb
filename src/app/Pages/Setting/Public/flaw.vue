<template>
	<div>
		<div class="clearfix text-right">
			<span id="public-data" class="text-md pull-left l-h36">瑕疵（公共数据）</span>
		...
		<div class="m-t-vl claerfix text-right">
			<span id="private-data" class="text-md pull-left l-h36">瑕疵（私有数据）</span>
		  <div class="w dis-inline m-l m-r-lg">
			...
			<auth perm="setting.public.data.project.update">
		  	<el-button @click="addForm('ruleForm')" type="primary"><i class="el-icon-plus m-r-xs"></i>添加瑕疵</el-button>
			</auth>
		</div>
		<div class="m-t-lg">
			<el-table class="ukao-el-table"
        ...
        this.$refs[formName].validate((valid) => {
					if (valid) {
						this.$store.dispatch('add', {
							uri: this.ruleForm.id ? 'productFlaw/update': 'productFlaw/add',
