<template>
	<div>
		<div class="clearfix text-right">
			<span id="public-data" class="text-md pull-left l-h36">衣物附件（公共数据）</span>
		...
		<div class="m-t-vl claerfix text-right">
			<span id="private-data" class="text-md pull-left l-h36">衣物附件（私有数据）</span>
		  <div class="w dis-inline m-l m-r-lg">
			...
			<auth perm="setting.public.data.project.update">
		  	<el-button @click="addForm('ruleForm')" type="primary"><i class="el-icon-plus m-r-xs"></i>添加衣物附件</el-button>
			</auth>
		</div>
		<div class="m-t-lg">
			<el-table class="ukao-el-table"
	...
	export default {
		...
		methods: {
			...
			templateList (start){
				...
				this.$store.dispatch('getTemplateList', {
					uri : 'productAnnex/template/list',
					params: {
						startRow: start || 0,
      ...
      submitForm(formName) {
        this.$refs[formName].validate((valid) => {
					if (valid) {
						this.$store.dispatch('post', {
							uri: this.ruleForm.id ? 'productAnnex/update': 'productAnnex/add',
